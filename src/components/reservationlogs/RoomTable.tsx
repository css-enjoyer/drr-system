...
const RoomTable: React.FC<RoomTableProps> = ({ selectedBranch }) => {
    const columns = [
        ...
        { id: "roomId", name: "ID" },
        { id: "roomMinPax", name: "Minimum Capacity" },
        { id: "roomMaxPax", name: "Maximum Capacity" },
    ...
    ******************************/
    ...
    const [roomMinPax, setMinPax] = useState<number | string>("");
    const [roomMaxPax, setMaxPax] = useState<number | string>("");
    ...
    const handleEdit = (roomId: number) => {
        ...
        if (rowToEdit) {
            ...
            setMinPax(rowToEdit.roomMinPax);
            setMaxPax(rowToEdit.roomMaxPax);
        ...
        <div style={{ textAlign: "center", marginTop: "20px" }}>
            ...
            <Dialog open={openEditDialog} onClose={handleCancelEdit} maxWidth="lg">
                ...
                <DialogContent style={{ width: "500px", height: "340px" }}>
                    ...
                    />
                    <TextField
                        label="New Minimum Pax Capacity"
                        type="number"
                        inputProps={{ min: 1, max: 12 }}
                        variant="outlined"
                        value={roomMinPax}
                    ...
                    />
                    <TextField
                        label="New Maximum Pax Capacity"
                        type="number"
                        inputProps={{ min: 1, max: 12 }}
                        variant="outlined"
                        value={roomMaxPax}
